...
cleanup() {
    ...
    rm -f test_json.json test_json.min.json server_test.log base64_dec.txt base64_dec.txt.bin
}
trap cleanup EXIT
...
if put_file base64_dec.txt http://127.0.0.1:8081/convert/base64-dec/in/base64_dec.txt &&
   get_file http://127.0.0.1:8081/convert/base64-dec/out/base64_dec.txt.bin base64_dec.txt.bin; then
