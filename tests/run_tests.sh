...
if put_file base64.txt http://127.0.0.1:8081/convert/base64/in/base64.txt &&
   get_file http://127.0.0.1:8081/convert/base64/out/base64.txt.b64.txt base64.txt.b64.txt; then
    ...
    if [ "$(cat base64.txt.b64.txt)" = "YWJj" ] || [ "$(cat base64.txt.b64.txt)" = "YWJj\n" ]; then
        pass "base64.txt.b64.txt content matches"
    else
        fail "base64.txt.b64.txt content mismatch"
    fi
else
...
if put_file base64_dec.txt http://127.0.0.1:8081/convert/base64-dec/in/base64_dec.txt &&
   get_file http://127.0.0.1:8081/convert/base64-dec/out/base64_dec.bin base64_dec.bin; then
