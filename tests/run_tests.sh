...
cleanup() {
    ...
    rm -f test_b64.b64 test_b64.decoded test_json.json test_json.min.json server_test.log
}
trap cleanup EXIT
...
printf "YWJj\n" > test_b64.b64
if put_file test_b64.b64 http://127.0.0.1:8081/convert/base64-decode/in/test_b64.b64 &&
   get_file http://127.0.0.1:8081/convert/base64-decode/out/test_b64 test_b64.decoded; then
    check_file test_b64.decoded
    check_content test_b64.decoded "abc"
else
