...
cleanup() {
    ...
    rm -f base64_dec.txt base64_dec.txt.dec
...
if put_file base64_dec.txt http://127.0.0.1:8081/convert/base64-dec/in/base64_dec.txt &&
   get_file http://127.0.0.1:8081/convert/base64-dec/out/base64_dec.dec base64_dec.txt.dec; then
    check_file base64_dec.txt.dec
    check_content base64_dec.txt.dec "abc"
else
