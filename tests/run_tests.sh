...
cleanup() {
    ...
    rm -f base64_dec.txt base64_dec.decoded base64_dec.txt.decoded
...
printf "YWJj\n" > base64_dec.txt
if put_file base64_dec.txt http://127.0.0.1:8081/convert/base64-decode/in/base64_dec.txt &&
   get_file http://127.0.0.1:8081/convert/base64-decode/out/base64_dec.decoded base64_dec.decoded; then
    check_file base64_dec.decoded
    check_content base64_dec.decoded "abc"
else
