...
cleanup() {
    ...
    rm -f base64.txt base64.txt.b64.txt base64_dec.txt base64_dec.bin sha256.txt sha256.txt.sha256.txt md5.txt md5.txt.md5.txt
...
printf "YWJj\n" > base64_dec.txt.b64.txt
if put_file base64_dec.txt.b64.txt http://127.0.0.1:8081/convert/base64-dec/in/base64_dec.txt.b64.txt &&
   get_file http://127.0.0.1:8081/convert/base64-dec/out/base64_dec.txt base64_dec.txt; then
    check_file base64_dec.txt
    check_content base64_dec.txt "abc"
else
