...
cleanup() {
    ...
    rm -f base64.txt base64.txt.b64.txt base64_decode_in.txt base64_decode_in.decoded.bin sha256.txt sha256.txt.sha256.txt md5.txt md5.txt.md5.txt
...
printf "YWJj\n" > base64_decode_in.txt
if put_file base64_decode_in.txt http://127.0.0.1:8081/convert/base64-decode/in/base64_decode_in.txt &&
   get_file http://127.0.0.1:8081/convert/base64-decode/out/base64_decode_in.decoded.bin base64_decode_in.decoded.bin; then
    check_file base64_decode_in.decoded.bin
    check_content base64_decode_in.decoded.bin "abc"
else
