...
cleanup() {
    ...
    rm -f base64.txt base64.txt.b64.txt base64.txt.b64.bin sha256.txt sha256.txt.sha256.txt md5.txt md5.txt.md5.txt
...
# Note: we use base64.txt.b64.txt generated from the previous step as input.
if put_file base64.txt.b64.txt http://127.0.0.1:8081/convert/base64-dec/in/base64.txt.b64.txt &&
   get_file http://127.0.0.1:8081/convert/base64-dec/out/base64.txt.b64.bin base64.txt.b64.bin; then
    check_file base64.txt.b64.bin
    check_content base64.txt.b64.bin "abc"
else
