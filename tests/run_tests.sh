...
cleanup() {
    ...
    rm -f base64.txt base64.txt.b64.txt b64_decode.b64.txt b64_decode.txt sha256.txt sha256.txt.sha256.txt md5.txt md5.txt.md5.txt
...
printf "YWJj\n" > b64_decode.b64.txt
if put_file b64_decode.b64.txt http://127.0.0.1:8081/convert/base64-decode/in/b64_decode.b64.txt &&
   get_file http://127.0.0.1:8081/convert/base64-decode/out/b64_decode b64_decode.txt; then
    check_file b64_decode.txt
    check_content b64_decode.txt "abc"
else
